...
#define MOVE_ROOST          MOVE_POUND
#define MOVE_SMACK_DOWN     MOVE_POUND
#define MOVE_SLUDGE_WAVE    MOVE_POUND
#define MOVE_LOW_SWEEP      MOVE_POUND
...
#define MOVE_CHARGE_BEAM    MOVE_POUND
#define MOVE_SKY_DROP       MOVE_POUND
#define MOVE_BRUTAL_SWING   MOVE_POUND
#define MOVE_QUASH          MOVE_POUND
#define MOVE_ACROBATICS     MOVE_POUND
#define MOVE_EMBARGO        MOVE_POUND
#define MOVE_SHADOW_CLAW    MOVE_POUND
#define MOVE_PAYBACK        MOVE_POUND
#define MOVE_SMART_STRIKE   MOVE_POUND
#define MOVE_GIGA_IMPACT    MOVE_POUND
#define MOVE_ROCK_POLISH    MOVE_POUND
#define MOVE_AURORA_VEIL    MOVE_POUND
#define MOVE_STONE_EDGE     MOVE_POUND
#define MOVE_VOLT_SWITCH    MOVE_POUND
#define MOVE_GYRO_BALL      MOVE_POUND
#define MOVE_BULLDOZE       MOVE_POUND
#define MOVE_FROST_BREATH   MOVE_POUND
#define MOVE_X_SCISSOR      MOVE_POUND
#define MOVE_DRAGON_TAIL    MOVE_POUND
#define MOVE_INFESTATION    MOVE_POUND
#define MOVE_POISON_JAB     MOVE_POUND
#define MOVE_GRASS_KNOT     MOVE_POUND
#define MOVE_U_TURN         MOVE_POUND
#define MOVE_FLASH_CANNON   MOVE_POUND
#define MOVE_TRICK_ROOM     MOVE_POUND
#define MOVE_WILD_CHARGE    MOVE_POUND
#define MOVE_SNARL          MOVE_POUND
#define MOVE_DARK_PULSE     MOVE_POUND
#define MOVE_DAZZLING_GLEAM MOVE_POUND
#define MOVE_CONFIDE        MOVE_POUND
